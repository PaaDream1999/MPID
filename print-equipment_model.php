...
<body onload="window.print(); window.location='main.php?page=equipment_model-list-report';">
<!--
 <body> 
...
<?php  //	ถ้าไม่มีข้อมูล
	...
	<strong>รายงานวันที่</strong> <?=fcDate($txtDate1)?> <strong>ถึง</strong> <?=fcDate($txtDate2)?> 
	  ...
	  <table id="table-hover" width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-condensed  table-bordered" style="font-size: 12px;">
        <tr>
          <td id="f-center" width="10%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ลำดับ</strong></td>
          <td id="f-center" width="32%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ชื่อครุภัณฑ์</strong></td>
          <td id="f-center" width="31%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ประเภทครุภัณฑ์</strong></td>
          <td id="f-center" width="14%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ราคา</strong></td>
          <td id="f-center" width="13%" align="center" valign="middle" bgcolor="#F4F4F4" ><strong> จำนวนเครื่อง</strong></td>
        </tr>
...
?>
         ...
         <tr class="list-hover">
          <td id="f-center" width="10%" align="center" valign="middle"><b><?=$no?></b></td>
          <td align="left" valign="middle">
		  <a href="main.php?page=equipment_model-detail&ID=<?=$ID?>"><?=$name?></a>		  </td>
          <td align="center" valign="middle"><?=$type_name?></td>
          <td id="f-center"  align="center" valign="middle" ><?=$price?></td>
          <td id="f-center" width="13%" align="center" valign="middle">
		  <strong><?=number_format($serviceNum)?></strong> 	 </td>
        </tr>
