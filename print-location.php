...
include "session-start.php";
		...
		$titlepage = "ข้อมูลสถานทีใช้ครุภัณฑ์";
...
<body onload="window.print(); window.location='main.php?page=location-list-report';">
<!--
 <body> 
	...
	<strong>รายงานวันที่</strong> <?=fcDate($txtDate1)?> <strong>ถึง</strong> <?=fcDate($txtDate2)?> 
	  ...
	  <table id="table-hover" width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-condensed  table-bordered" style="font-size: 12px;">
        <tr>
          ...
          <td id="f-center" width="43%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ข้อมูลสถานทีใช้ครุภัณฑ์</strong></td>
          <td id="f-center" width="24%" align="center" valign="middle" bgcolor="#F4F4F4" ><strong>จำนวนห้องที่ใช้ครุภัณฑ์</strong></td>
          <td id="f-center" width="22%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>จำนวนเครื่อง</strong></td>
        </tr>
...
?>
         ...
         <tr class="list-hover">
          ...
          <td id="f-center" width="24%" align="center" valign="middle"><?=number_format($labNum)?></td>
          <td id="f-center" width="22%" align="center" valign="middle"><?=number_format($serviceNum)?></td>
        </tr>
