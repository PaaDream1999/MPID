...
<div id="box-list">		
<h2 id="title-list">ข้อมูลประเภทครุภัณฑ์</h2> 
<?php  
...
<?php  //	ถ้าไม่มีข้อมูล
	  ...
	  <table id="table-hover" width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-condensed  table-bordered" style="font-size: 12px;">
        <tr>
          ...
          <td id="f-center" width="71%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ข้อมูลประเภทครุภัณฑ์</strong></td>
...
?>
		 ...
		 <a  href="main.php?page=<?=$pageUrl?>-edit&ID=<?=$ID?>"><strong>  แก้ไข</strong></a> </td>
          <td id="f-center" width="9%" align="center" valign="middle"> 
		  <a   href="<?php echo $Action; ?>?Table=<?php echo $pageUrl; ?>&Sql=Delete&ID=<?=$ID?>" onclick="return confirm('ยืนยันลบข้อมูล <?=$name?> ออกจากระบบ')"><strong>  ลบ</strong></a>		  </td>
        </tr>
