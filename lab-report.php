...
<div id="box-list">		
<h2 id="title-list">ข้อมูลห้องที่ใช้ครุภัณฑ์</h2> 
<?php  
...
<?php  //	ถ้าไม่มีข้อมูล
	  ...
	  <table id="table-hover" width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-condensed  table-bordered" style="font-size: 12px;">
        <tr>
          ...
          <td id="f-center" width="23%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>ข้อมูลห้องที่ใช้ครุภัณฑ์</strong></td>
          <td id="f-center" width="37%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>สถานที่ใช้ครุภัณฑ์</strong></td>
          <td id="f-center" width="17%" align="center" valign="middle" bgcolor="#F4F4F4"><strong>จำนวนเครื่อง</strong></td>
          <td id="f-center" width="8%" align="center" valign="middle" bgcolor="#F4F4F4" ><strong><i class="icon-edit"></i> แก้ไข</strong></td>
          <td id="f-center" width="8%" align="center" valign="middle" bgcolor="#F4F4F4"><strong><i class="icon-trash"></i> ลบ</strong></td>
        </tr>
...
?>
         ...
         <tr class="list-hover">
          ...
          <td id="f-left" align="left" valign="middle"><?=$type_name?></td>
          <td id="f-center" align="left" valign="middle"><?=number_format($count)?></td>
          <td id="f-center" width="8%" align="center" valign="middle">
